                ...
                <div className="relative w-full h-32 flex items-center justify-center mb-3">
                  <Image
                    ...
                    onError={(e) => {
                      ...
                      if (parent) {
                        parent.innerHTML = `<div class="text-center text-sm font-medium text-muted-foreground">${partner.name}</div>`
                      }
                    }}
                  />
                </div>
                <p className="text-center text-xs md:text-sm font-medium text-foreground/80 line-clamp-2">
                  {partner.name}
                </p>
